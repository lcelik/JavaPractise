...
public interface EmployeeDao extends JpaRepository<Employee, Integer> {
	...
	//Adding Search Employees By Department method by following naming convention to declare the function
	List<Employee> findByEmpDepartment(String department);
	
	//Adding Display list of Employess who get salary more than 50000 method by following naming convention to declare the function
