...
//	public ModelAndView incrementSalaryController(HttpServletRequest request) {
	public ModelAndView incrementSalaryController(@RequestParam("eId") int id,@RequestParam("increment") double incrementAmount) {
		ModelAndView modelAndView = new ModelAndView();
...
//	public ModelAndView searchEmployeeById(HttpServletRequest request) {
	public ModelAndView searchEmployeeById(@RequestParam("empId") int id) {
		ModelAndView modelAndView = new ModelAndView();
...
//		return new ModelAndView("InputInfoForAdd");
		...
		return new ModelAndView("InputInfoForAdd", "emp", new Employee());
	}
...
//		newEmployee.setEmpSalary(salary);
		...
		if (employeeService.addEmployee(newEmployee))
			message = "Employee Added with ID " + newEmployee.getEmpId();
		else
...
//	public ModelAndView searchEmployeesByDesignation(HttpServletRequest request) {
	public ModelAndView searchEmployeesByDesignation(@RequestParam("designation") String designation) {
		ModelAndView modelAndView = new ModelAndView();
//		String designation = request.getParameter("designation");
...
//	public ModelAndView deleteEmployeeNameController(HttpServletRequest request) {
	public ModelAndView deleteEmployeeNameController(@RequestParam("employeeName") String name) {
		ModelAndView modelAndView=new ModelAndView();
//		String name=request.getParameter("employeeName");
		String message=null;
